public class TestEmployee
{
    public static void main(String[] args)
    {
        ...
        Employee em2 = new Employee("522H0090", "Vo Nhat Hao", 2018, 1.5, 0);
        Manager ma2 = new Manager(em2.getID(), em2.getFullName(), em2.getCoefficientsSalary(), "Head of the administrator office", 5.0);
