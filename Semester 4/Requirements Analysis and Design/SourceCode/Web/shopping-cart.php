                ...
                <div class="s-cart-all">
                    <div class="cart-form table-responsive">
                        ...
                        if (!isset($_COOKIE['tendangnhap'])) {
                            echo '<p style="font-weight: bold; text-align: center; font-size: 16px;">Please sign in before adding to the cart.</p>
                                        <hr class="opacity-20">
                                        <div class="row">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <div class="wc-proceed-to-checkout" style="text-align: center;">
                                                        <p class="return-to-shop">
                                                            <a class="button wc-backward" href="login.php">Please sign in to countinue</a>
                                                        </p>
</div>
                                                </div>
                                            </div>
                    ...
                    <div>
                            ...
                            echo '<p style="font-weight: bold; text-align: center; font-size: 16px;">There are no items in the cart.</p>
                                        <hr class="opacity-20">
                    ...
                    <div>
                            ...
                            <table id="shopping-cart-table" class="data-table cart-table">
                                <tr>
                                    <th class="low8">Number</th>
                                    <th class="low1">Picture</th>
                                    <th class="low1">Product</th>
                                    <th class="low7">Quantity</th>
                                    <th class="low7">Price</th>
                                    <th class="low7">Total price</th>
                                    <th></th>
                                </tr>
                                <tr>
                                    <?php
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <style>
                            ...
                            .wc-proceed-to-checkout a.wc-forward {
                                ...
                                /* Điều chỉnh màu nền cho cả hai nút */
                            }
                        </style>
                        <div class="wc-proceed-to-checkout">
                            <p class="return-to-shop">
