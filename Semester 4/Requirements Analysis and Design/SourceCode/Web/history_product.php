    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="con-text">
                    <h2 class="page-title">History Order</h2>
                    <p><a href="index.php">Home</a> | History Order</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="cart-form table-responsive">
                                <?php
                                    if(!isset($_COOKIE['tendangnhap'])){
                                        echo '<p style="font-weight: bold; text-align: center; font-size: 16px;">Please sign in before view history order.</p>
                                        <hr class="opacity-20">
                                        <div class="row">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <div class="wc-proceed-to-checkout" style="text-align: center;">
                                                        <p class="return-to-shop">
                                                            <a class="button wc-backward" href="login.php">Sign in to continue!</a>
                                                        </p>
                    ...
                    <div>
                                ...
                                <table id="shopping-cart-table" class="data-table cart-table">
                                    <tr>
                                        ...
                                        <th class="low1">Product name</th>
                                        <th class="low7">Price</th>
                                        <th class="low7">Quantities</th>
