  ...
  if (empty($hovaten) || empty($email) || empty($message_contact)) {
    ...
    if (isset($_COOKIE['tendangnhap'])) {
      if ($hovaten != "" && $email != "" && $message_contact != "") {
        ...
        echo '<script>alert("Send support message success.");
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="con-text">
                    <h2 class="page-title">Support Customer</h2>
                    <p><a href="index.php">Home</a> | Support Customer</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="content">
      <form action="#" method="POST">
        <div class="user-details">
          <?php
          if (isset($_COOKIE['tendangnhap'])) {
            echo '<p style="font-weight: bold; text-align: center; font-size: 16px;">Hi ' . $_COOKIE['tendangnhap'] . '</p>';
          } else {
            echo '<p style="font-weight: bold; text-align: center; font-size: 16px;">Hello guy! If you have any issues that need assistance, please contact us through the form.</p>';
          }
          ?>
          <div class="input-box">
