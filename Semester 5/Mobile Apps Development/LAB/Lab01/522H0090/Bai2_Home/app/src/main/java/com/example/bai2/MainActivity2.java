...
//        }
        int selectedRadioId = rgPlatforms.getCheckedRadioButtonId();
//        int selectedId = rgPlatforms.getCheckedRadioButtonId();
//        RadioGroup selectedRadioButton = findViewById(selectedId);
//        if (selectedRadioButton != null) {
//            tvResults2.setText("The following were selected... " + selectedRadioButton.getTextAlignment());
...
//            tvResults2.setText("No platform selected.");
//        }
//        tvResults2.setText(result.toString());
//
        String selectedPlatform = "No selected.";
        if (selectedRadioId == R.id.rbAndroid) {
            selectedPlatform = "Android";
        } else if (selectedRadioId == R.id.rbIOS) {
            selectedPlatform = "iOS";
        } else if (selectedRadioId == R.id.rbWindows) {
            selectedPlatform = "Windows";
        } else if (selectedRadioId == R.id.rbRIM) {
            selectedPlatform = "RIM";
        }
        result.append("Selected: ").append(selectedPlatform);
