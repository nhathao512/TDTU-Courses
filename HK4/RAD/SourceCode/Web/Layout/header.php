            ...
            <div class="row">
                <div class="col-md-6 col-sm-4">
                    <div class="left-header clearfix">
                        <ul>
                            <li>
                                <p><i class="fa fa-phone" aria-hidden="true"></i>(+84) 3295 45212</p>
                            </li>
                            <li class="hd-none">
                                <p><i class="fa fa-clock-o" aria-hidden="true"></i>Mon-Sat : 9:00 AM - 7:00 PM</p>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-sm-8">
                    <div class="right-header ">
                        <ul>
                            ...
                            <li><a href="shopping-cart.php"><i class="fa fa-shopping-cart"></i>Shopping Cart</a></li> <?php
                            if (isset($_COOKIE['tendangnhap'])) {
                                ...
                                if ($result && mysqli_num_rows($result) > 0) {
                                    ...
                                    echo '
                                                <li><a href="changePass.php"><i class="fas fa-exchange-alt"></i>Change password</a> <br></li>
<li><a href="history_product.php"><i class="fas fa-history"></i>Order</a><br></li>
                                                <li><a href="mailbox.php"><i class="fas fa-inbox"></i>Support Message</a><br></li>
                                                <li><a href="logout.php"><i class="fas fa-sign-out-alt"></i>Logout</a></li>
                                                <li></li>
                                                </div></ul>';
                                } else {
                                    // Xử lý lỗi khi không lấy được thông tin người dùng
                                    echo "Error can't load customer information.";
                                }
                            } else {
                                echo '<li><a href="login.php"><i class="fa fa-lock"></i>Sign in</a></li>
...
<li style="text-align: center;">
                                        ...
                                        <li>
                                            <div class="goto text-center">
                                                <a href="shopping-cart.php"><strong>Go to cart &nbsp;<i
                                                            class="pe-7s-angle-right"></i></strong></a>
                                            </div>
                                        </li>
                                        <li class="checkout-btn text-center">
                                            <a href="checkout_product.php">Pay</a>
                                        </li>
...
<script type="text/javascript">
    ...
    function updatePrice() {
        ...
        document.getElementById('total-price').innerText = new Intl.NumberFormat('de-DE').format(totalPrice) + ' VNĐ';
    }
</script>