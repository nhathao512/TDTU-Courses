...
<div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
    ...
    if (isset($_GET['id'])) {
        ...
        echo '<h5 class="mb-0">Edit Brand</h5>';
    } else {
        // Nếu không, hiển thị "Add Customer"
        echo '<h5 class="mb-0">Add Brand</h5>';
    }
    ?>
</div>
                    ...
                    <div class="table-responsive">
                        ...
                        <div class="panel-body">
                            <form method="POST">
                                ...
                                <hr class="navbar-divider my-3 opacity-20">
                                <button class="btn btn-success" onclick="addCollection()">Save</button>
                                <?php
    ...
    <script type="text/javascript">
        ...
        {
            var option = confirm('Add new brand success')
            if (!option) {
                return;
            }
        }
